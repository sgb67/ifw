### cESFW filtering + running embryo ###
##### Dependencies #####
...
subsetted_matrix = pd.DataFrame(data=Scaled_Matrix)
#subsetted_matrix.to_csv('subsetted_matrix_new_cESFW_embryo.csv')

subsetted_genes = pd.Series(data=Scaled_Matrix.columns)
#subsetted_genes.to_csv('subsetted_genes_new_cESFW_embryo.csv')
...
#ESSs.to_csv('ESSs_new_cESFW_embryo.csv')

#EP = pd.DataFrame(data=EPs, columns=column_name, index=column_name)
#EP.to_csv('EP_new_cESFW_embryo.csv')
