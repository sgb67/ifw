...
chipall.to_csv('final_chip_synthetic.csv')

chistatall = pd.DataFrame(data=chistatall, columns=column_name, index=column_name)
chistatall.to_csv('final_chistat_synthetic.csv')
...
fetpall.to_csv('final_fetp_synthetic.csv')

fetstatall = pd.DataFrame(data=fetstatall, columns=column_name, index=column_name)
fetstatall.to_csv('final_fetstat_synthetic.csv')
